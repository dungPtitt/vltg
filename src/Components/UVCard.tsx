...
import { convertNameToSlug, notifyError, notifySuccess } from "@/utils/generalFunction";
    ...
    <div className="w-full border-t-2 border-blue-500 py-2 hover:border-l-3-yellow-600">
      <div className="flex justify-between">
        <div className="flex items-center w-1/2 pl-5 py-3">
          <Image
            onClick={() => router.push(`/ung-vien-${convertNameToSlug(dataUV.userName) }-${dataUV.idTimViec365}.html`)}
